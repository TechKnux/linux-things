-- awesome_mde: api-level=4:screen=on
...
--Display config
awful.spawn("xrandr --output HDMI-0 --mode 1360x768 --primary")
...
--beautiful.init(gears.filesystem.get_themes_dir() .. "/home/mmpc/.config/awesome/themes/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "F7", function() awful.util.spawn("heroic") end,
              {description = "Open Heroic Games Launcher", group = "Games"}), 
...
-- Default tag spawning
    ...
    -- Discord on tag 2 
     { rule_any = { class = {"discord", "Discord", "discord-bin", "WebCord" } },
       properties = { screen = 1, tag = "2" } },
    ...
    -- Launchers on tag 8 
     { rule_any = { class = {"Steam", "Lutris", "Battle.net", "Mednaffe", "heroic"} },
       properties = { screen = 1, tag = "8" } },
    
    -- Games on tag 9 
     { rule_any = { class = {"steam", "mednafen"} },
...
-- {{{ Autorun
-- awful.spawn("sudo alsactl restore")
awful.spawn("/home/mmpc/.config/autorun.sh")
-- }}}
